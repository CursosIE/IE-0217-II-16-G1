 ...
 *
 * Funcion que indica si la pila está vacia.
 *
 */
  ...
  void New(int tamArreglo){ /*Crear Stack nueva, instanciar la clase*/
		pilaConArreglo->ListaConArreglo(tamArreglo);
  }
